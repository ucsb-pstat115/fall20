...
- Many possible sufficient stattistics
...
- Let $X_1, X_2,\dots, X_n$  $i.i.d \sim N(\mu,\sigma^2)$.
$$
\begin{aligned}
...
Here, $h=1$. $T=(\sum_{i=1}^{n} X_{i}, \sum_{i=1}^{n} X_{i}^{2})$ is sufficient (minimal sufficient).
